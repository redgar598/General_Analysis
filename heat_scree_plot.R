...
## If you scale and center in this princomp, shit going to get crazy (PC0 will effectively be removed twice if you do). 
# Someone will someday update this so it works with center and scale
